  ...
  const shareToSocialMedia = (platform) => {
    ...
    const shareUrls = {
      ...
      instagram: () => {
        ...
        copyToClipboard();
        alert("Link copied to clipboard! Instagram doesn't support direct sharing via web. Please paste this link in your Instagram app.");
      }
    };
  ...
  return (
    <div className="feeds-container">
      <div className="feeds-header-container" onClick={() => navigate("/profile")}>
        ...
        <button type="button" onClick={onClickLogout} className="feed-logout"><BiLogOut /></button>
      </div>
      <h1>Feeds</h1>
